var money = document.getElementById('withdraw_money')
var yes = document.getElementById('yes')
var no = document.getElementById('no')

money.innerHTML = localStorage.getItem('withdraw_money')
...
function success(){
    ...
    var cur_val = Number(localStorage.getItem('balance')) - Number(localStorage.getItem('withdraw_money')) 
    localStorage.setItem('balance',String(cur_val))
    ...
    f_out.push(localStorage.getItem('withdraw_money'))
