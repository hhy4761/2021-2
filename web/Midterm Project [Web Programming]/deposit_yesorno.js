...
deposit_money.innerHTML = localStorage.getItem('deposit_money')

yes.addEventListener('click',deposit_yes)
no.addEventListener('click',deposit_no)
...
function deposit_yes(){
    ...
    var now = new Date()
    var cur_bal = Number(localStorage.getItem('balance'))+Number(localStorage.getItem('deposit_money'))
    ...
    f_in.push(localStorage.getItem('deposit_money'))
    ...
    window.location.href = 'deposit_check.html'
